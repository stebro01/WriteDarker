        ...
        <div class="flex justify-between items-center h-12">
          ...
          <div class="flex items-center space-x-4">
            ...
            <div class="flex items-center">
              ...
              <h1 class="text-lg font-semibold text-gray-900">{{ projectTitle }}</h1>
            </div>
          </div>
    ...
    <div class="flex-1 flex overflow-hidden">
      ...
      >
        ...
        <div class="p-3 border-b border-gray-200 flex items-center justify-between">
          <h3 v-if="!leftSidebarCollapsed" class="text-sm font-medium text-gray-900">References & Files</h3>
          <button
        ...
        <div v-if="!leftSidebarCollapsed" class="flex-1 overflow-y-auto p-3">
          ...
          <!-- References section -->
          <div class="mb-6">
            <h4 class="text-xs font-medium text-gray-500 uppercase tracking-wide mb-2">References</h4>
            <div class="space-y-2">
              <div
          ...
          <!-- Media files section -->
          <div class="mb-6">
            <h4 class="text-xs font-medium text-gray-500 uppercase tracking-wide mb-2">Media Files</h4>
            <div class="space-y-2">
              <div
        ...
        <div class="flex-1 p-6 overflow-y-auto">
          <div class="max-w-4xl mx-auto">
            ...
            <input
              ...
              class="w-full text-2xl font-bold text-gray-900 bg-transparent border-none outline-none mb-6 placeholder-gray-400"
            ...
            <div class="prose prose-lg max-w-none">
              <textarea
                ...
                class="w-full h-96 resize-none border-none outline-none text-gray-700 placeholder-gray-400 leading-relaxed"
        ...
        <div class="border-t border-gray-200 bg-gray-50/50">
          ...
          <div class="px-6 py-3 bg-white border-b border-gray-200">
            <div class="flex items-center justify-between">
              <div class="flex items-center">
                <div class="w-6 h-6 bg-gradient-to-r from-orange-400 to-orange-600 rounded-full flex items-center justify-center mr-2">
                  <svg class="w-3 h-3 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <!-- Chat messages -->
          <div v-if="!chatCollapsed" class="h-64 overflow-y-auto p-4">
            <div class="space-y-4">
              <div
          ...
          <!-- Chat input -->
          <div v-if="!chatCollapsed" class="p-4 bg-white border-t border-gray-200">
            <div class="flex space-x-3">
              ...
              />
              <BaseButton @click="sendMessage" variant="primary" size="sm">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      >
        <template v-if="!rightSidebarCollapsed">
          ...
          <div class="p-3 border-b border-gray-200 flex items-center justify-between">
            ...
            <h3 class="text-sm font-medium text-gray-900">Tools & Options</h3>
          </div>
          ...
          <div class="flex-1 overflow-y-auto p-3">
            <!-- Document stats -->
            <div class="mb-6">
              <h4 class="text-xs font-medium text-gray-500 uppercase tracking-wide mb-3">Document Stats</h4>
              <div class="space-y-3">
                <div class="bg-gray-50 rounded-lg p-3">
                  <div class="text-center">
                    <div class="text-lg font-bold text-gray-900">{{ documentStats.words }}</div>
                    <div class="text-xs text-gray-500">Words</div>
                  </div>
                </div>
                <div class="grid grid-cols-2 gap-2">
                  <div class="bg-gray-50 rounded-lg p-2 text-center">
                    <div class="text-sm font-semibold text-gray-900">{{ documentStats.characters }}</div>
                    <div class="text-xs text-gray-500">Characters</div>
                  </div>
                  <div class="bg-gray-50 rounded-lg p-2 text-center">
                    <div class="text-sm font-semibold text-gray-900">{{ documentStats.paragraphs }}</div>
            ...
            <!-- Writing tools -->
            <div class="mb-6">
              <h4 class="text-xs font-medium text-gray-500 uppercase tracking-wide mb-3">Writing Tools</h4>
              <div class="space-y-2">
            ...
            <!-- Export options -->
            <div class="mb-6">
              <h4 class="text-xs font-medium text-gray-500 uppercase tracking-wide mb-3">Export Options</h4>
              <div class="space-y-2">
